...
public class HomeViewController{
    ...
    public HomeViewController(HomeView vista) {
        ...
        vista.jMenuName.setText(String.format("Bienvenid@ %s", vendedor.getNombreUsuario()));
        agregarEvento();
    }
    ...
    public Image getIconImage() {
        Image retValue = Toolkit.getDefaultToolkit().getImage(ClassLoader.getSystemResource("com/electrika/tech/img/logo_1.png"));
        return retValue;
    }
}
